...
def add_cook_args(parser: argparse.ArgumentParser):
    group = parser.add_argument_group("cook", "cook configurations")
    group.add_argument('--teacher-config', type=str, help="teacher configuration file")
    group.add_argument('--load-teacher', type=str, help="model checkpoint")
    group.add_argument('--cook-config', type=str, help='Path to BMCook config file')
    return parser
